import { fetchTasks, removeTaskTC, tasksActions, tasksReducer, TasksStateType, updateTaskTC } from './tasks-reducer'
...
test('propertry with todolistId should be deleted', () => {
	const action = removeTodolistTC.fulfilled({ id: 'todolistId2' }, '', { id: 'todolistId2' })
